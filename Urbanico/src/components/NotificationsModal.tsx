...
const INITIAL_NOTIFICATIONS: SiteNotification[] = [
  {
    id: 'notif-1',
    type: 'dispatch',
    title: 'Tipper En-Route to Site',
    message: '10-Tyre Tipper (TS 08 UB 8821) loaded with 3T Plastering Sand departed Miyapur Yard. ETA: 35 mins.',
    time: '12 mins ago',
    isUnread: true,
  },
  {
    id: 'notif-2',
    type: 'weighment',
    title: 'Automated Weighbridge Tare Verified',
    message: 'Digital gross tare slip generated: Gross 26,450 KG | Tare 10,450 KG | Net 16,000 KG. Certified zero tare difference.',
    time: '45 mins ago',
    isUnread: true,
  },
  {
    id: 'notif-3',
    type: 'combo',
    title: 'Trending Combo Deal Active',
    message: 'Masonry & Plastering Combo (1,000 Bricks + Sand Auto + 10 Bags UltraTech) is trending in Hyderabad with flat combo pricing.',
    time: '2 hours ago',
    isUnread: false,
  },
  {
    id: 'notif-4',
    type: 'rate',
    title: 'Direct Yard Freight Update',
    message: 'Express site delivery rate calibrated at flat ₹5 / km from Hyderabad central logistics hub.',
    time: 'Today, 8:00 AM',
    isUnread: false,
  },
];
